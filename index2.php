...
<head>
	...
	<!-- title bar -->
	<title>National Polytechnic Collage</title>
	<!-- logo  -->
	<link rel="icon" type="image/x-icon" href="images/npcicon.ico">
	<!-- custom font  -->
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<ul class="tg-addressinfo">
								<li>
									...
									<address>Yakub Future Park, Plot No-5, Nasirabad
										Khulshi, Chattogram-4209.</address>
								</li>
								...
								<li><a  href="#" class="btn btn-primary btn-lg active btn-sm" role="button" aria-pressed="true">Profile</a>
									<a  href="reglog/logout.php" class="btn btn-primary btn-lg active btn-sm" role="button" aria-pressed="true">Log Out</a></li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="tg-navigationarea">
							<strong class="tg-logo"><a href="index.html"><img src="images/npclogo.png" alt="University of Education and knowledge"></a></strong>
											...
											<div class="mega-menu">
												<ul class="mega-menu-row">
													<li class="mega-menu-col">
														...
														<ul>
															<li><a href="#">Diploma in Electrical Technology</a></li>
															<li><a href="#">Diploma in Mechanical Technology</a></li>
															<li><a href="#">Diploma in Civil Technology</a></li>
															<li><a href="#">Diploma in Computer Technology</a></li>
															<li><a href="#">Diploma in Arcitecture Technology</a></li>
															<li><a href="#">Diploma in Textile Technology</a></li>
															<li><a href="#">Diploma in Automobile Technology</a></li>
														</ul>
													</li>
													<li class="mega-menu-col">
														<a href="javascript:void(0);">admissions assets</a>
														<ul>
															<li><a href="#">Admission Form</a></li>
															<li><a href="#">SSC/HSC Transcript</a></li>
															<li><a href="#">Academic Transcript</a></li>
															<li><a href="#">38 X 38 M.M. Photo (2 Copy)</a></li>
															<li><a href="#">Guardian NID card</a></li>
														...
														<div class="tg-themetabs">
															<ul class="tg-themetabnav" role="tablist">
																<li role="presentation" class="active">
																	<a href="#tg-science" aria-controls="tg-science" role="tab" data-toggle="tab">Electrical</a>
																</li>
																<li role="presentation">
																	<a href="#tg-management" aria-controls="tg-management" role="tab" data-toggle="tab">Mechanical</a>
																</li>
																<li role="presentation">
																	<a href="#tg-medical" aria-controls="tg-medical" role="tab" data-toggle="tab">Civil</a>
																</li>
																<li role="presentation">
																	<a href="#tg-arts" aria-controls="tg-arts" role="tab" data-toggle="tab">Computer</a>
																</li>
																<li role="presentation">
																	<a href="#tg-informationtechnology" aria-controls="tg-informationtechnology" role="tab" data-toggle="tab">Architecture</a>
																</li>
																<li role="presentation">
																	<a href="#tg-history" aria-controls="tg-history" role="tab" data-toggle="tab">Textile</a>
																</li>
																<li role="presentation">
																	<a href="#tg-economics" aria-controls="tg-economics" role="tab" data-toggle="tab"> Automobile</a>
																</li>
																<li role="presentation">
																	<a href="#tg-accounts" aria-controls="tg-accounts" role="tab" data-toggle="tab">Garments</a>
																</li>
															</ul>
															<div class="tab-content tg-themetabcontent">
																<div role="tabpanel" class="tab-pane tg-tabpane active" id="tg-science">
																	<strong>Latest Activies of ET</strong>
																	<div class="tg-posts">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-management">
																	<strong>Latest Activies of Mechanical Technology</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-medical">
																	<strong>Latest Activies of Civil Technology</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-arts">
																	<strong> Latest Activies of Computer Technology</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-informationtechnology">
																	<strong> Latest Activies of Architecture Technologys</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-history">
																	<strong> Latest Activies of Textile Technologys</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
																...
																<div role="tabpanel" class="tab-pane tg-tabpane" id="tg-economics">
																	<strong> Latest Activies of Automobile Technologys</strong>
																	<div class="tg-posts">
																		<div id="tg-navtabslider" class="tg-navtabslider tg-megamenuslider owl-carousel">
																			<div class="item">
																				<article class="tg-themepost">
							...
							<section class="tg-sectionspace tg-haslayout">
								<div class="tg-shortcode tg-welcomeandgreeting tg-welcomeandgreeting-v2">
									...
									<div class="tg-shortcodetextbox">
										<h2>Message of our honorable principal</h2>
										<div class="tg-description">
											<p>To execute the motto "Practical learning is the key precondition of employment" our mission and vision is to teach our students technical education on modern technology and practical education in our country which was originated by the blood of freedom was. It was established in 2002 and is very successful to implement technical education affiliated by BTEB (Bangladesh Technical education Board) and is running National polytechnic college (Diploma-in-Engineering Curriculum) in Chittagong through best and outstanding result the institute has been placed one of the best polytechnic institute in the realm of Diploma-in-Engineering. Running National Polytechnic College is the practical, modern, excellent, Modern and co-educational institute helps the student to be self-dragnet, impressive and civilized to representation the access into their practical lives. Every student builds his life through honesty, liberality, patriotism, discipline and become a good citizen by practicing and following these, above all open out their inventive mind, I will book get the main delight and the main achievement of our institute.</p>
										</div>
										<span class="tg-name">A.B.M Abdul Wahed
										</span>
										<span class="tg-designation">Principal,National Polytechnic Collage</span>
										<div class="tg-btnpluslogo">
											<a class="tg-btn" href="javascript:void(0);">read more</a>
											<strong class="tg-universitylogo"><a href="javascript:void(0);"><img src="images/npcicon.ico" alt="image description"></a></strong>
										</div>
									</div>
								</div>
							</section>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
												<article class="tg-themepost tg-eventpost">
													<figure class="tg-featuredimg">
														<a href="javascript:void(0);">
															<img src="images/events/img-08.jpg" alt="image description">
														</a>
													</figure>
													<div class="tg-themepostcontent">
														<ul class="tg-matadata">
											...
											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
												<article class="tg-themepost tg-eventpost">
													<figure class="tg-featuredimg">
														<a href="javascript:void(0);">
															<img src="images/events/img-09.jpg" alt="image description">
														</a>
													</figure>
													<div class="tg-themepostcontent">
														<ul class="tg-matadata">
											...
											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
												<article class="tg-themepost tg-eventpost">
													<figure class="tg-featuredimg">
														<a href="javascript:void(0);">
															<img src="images/events/img-10.jpg" alt="image description">
														</a>
													</figure>
													<div class="tg-themepostcontent">
														<ul class="tg-matadata">
											...
											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
												<article class="tg-themepost tg-eventpost">
													<figure class="tg-featuredimg">
														<a href="javascript:void(0);">
															<img src="images/events/img-12.jpg" alt="image description">
														</a>
													</figure>
													<div class="tg-themepostcontent">
														<ul class="tg-matadata">
											...
											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
												<article class="tg-themepost tg-eventpost">
													<figure class="tg-featuredimg">
														<a href="javascript:void(0);">
															<img src="images/events/img-13.jpg" alt="image description">
														</a>
													</figure>
													<div class="tg-themepostcontent">
														<ul class="tg-matadata">
		...
		<footer id="tg-footer" class="tg-footer tg-haslayout">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
							<div class="tg-widget tg-widgetcompanyinfo">
								<div class="tg-widgetcontent">
									<strong class="tg-logo"><a href="index.html"><img src="images/npclogo.png" alt="image description"></a></strong>
									<div class="tg-description">
										<p>Consectetur adipisicing elit sed do eiusmod tempor inunt labore... <a href="javascript:void(0);">Read More</a></p>
									</div>
			...
			<div class="tg-footerbar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<span class="tg-copyright"><a target="_blank" href="https://www.facebook.com/mejbahahmedfahim.maf/">@mejbah ahmed</a></span>
							<nav class="tg-addnav">
								<ul>
